# APA 0.1.0 - Memory System Guide 
This guide explains how APA sessions store and evolve memory using the **Dynamic-MD** system.

Memory duties are assigned to the *Manager Agent* - who maintains the system. Details on individual Memory Log files reside in .apa/guides/memory-log-guide.md.
...
**Memory Logs** capture granular, task-level context and are written by Implementation Agents after each task completion. See .apa/guides/memory-log-guide.md for schemas and writing rules.
...
**Example: Task "Task 2.1 - Deploy Updates | Agent_Backend" → `task-2-1-deploy-updates.md`**
